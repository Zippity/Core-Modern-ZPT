...
public class TFGMultiMachines {
    ...
    public static final MultiblockMachineDefinition INTERPLANETARY_ITEM_RECEIVER = REGISTRATE
            ...
            .pattern(def -> {
                ...
                return FactoryBlockPattern.start()
                        ...
                        .where("b",
                                Predicates.blocks(TFGBlocks.MACHINE_CASING_ALUMINIUM_PLATED_STEEL.get())
                        ...
                        .where("G",
                                Predicates.blocks(GTBlocks.YELLOW_STRIPES_BLOCK_A.get())
    ...
    public static final MultiblockMachineDefinition BIOREACTOR = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("D",
                            Predicates.blocks(ForgeRegistries.BLOCKS.getValue(ResourceLocation
