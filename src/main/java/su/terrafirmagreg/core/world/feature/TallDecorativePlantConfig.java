...
public record TallDecorativePlantConfig(Block block, int plantHeight, int minHeight, int maxHeight,
        int middle) implements FeatureConfiguration {
    ...
    public static final Codec<TallDecorativePlantConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.INT.fieldOf("middle").forGetter(c -> c.middle)).apply(instance, TallDecorativePlantConfig::new));
}
